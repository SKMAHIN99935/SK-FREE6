...
android_models=[]
try:
    xx = requests.get('https://github.com/SKMAHIN99935/SK-FREE6/blob/main/VEER.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/SKMAHIN99935/SK-FREE6/blob/main/VEER.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
def aprv():
    global km
    r=requests.get('https://github.com/SKMAHIN99935/SK-FREE6/blob/main/VEER.txt').text
    k=getKey()
    if k in r:
        main__manu()
